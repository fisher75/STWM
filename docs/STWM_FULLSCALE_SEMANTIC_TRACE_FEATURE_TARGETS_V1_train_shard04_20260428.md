...
- valid_target_ratio: `0.5098965763195435`
- no_future_candidate_leakage: `True`
- cache_path: `outputs/cache/stwm_fullscale_semantic_trace_feature_targets_v1_train_shard04_20260428/future_semantic_trace_feature_targets_v1.npz`
