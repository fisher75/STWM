...
- valid_target_ratio: `0.778152332361516`
- no_future_candidate_leakage: `True`
- cache_path: `outputs/cache/stwm_fullscale_semantic_trace_feature_targets_v1_val_shard00_20260428/future_semantic_trace_feature_targets_v1.npz`
