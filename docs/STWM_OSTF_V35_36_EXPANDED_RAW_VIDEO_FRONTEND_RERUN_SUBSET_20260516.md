# STWM OSTF V35.36 Raw Video Frontend Rerun Smoke
...
- joint_eval_ran: True
- semantic_smoke_passed_all_seeds: False
...
## 中文总结
V35.36 已完成 raw-video frontend rerun smoke，但还没有通过全部 smoke gate；当前不能把 M128/H32 video system claim 从 cache 闭环推进到 raw-video rerun 闭环。
