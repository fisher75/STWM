...
```json
{
  ...
  "created_at": "2026-04-27T17:04:04+0800",
  ...
  "stwm_long_gap_or_occlusion_improved_vs_strongest_external": false,
  "stwm_numerically_above_strongest_on_long_gap": true,
  "stwm_overall_external_sota": false,
  "stwm_significantly_above_strongest_on_long_gap": false,
  "stwm_significantly_above_strongest_on_occlusion": false,
  "stwm_significantly_improved_vs_cotracker_on_continuity_subsets": true,
  "stwm_significantly_improved_vs_sam2_on_continuity_subsets": false
}
```
