...
SESSION="tracewm_stage2_external_eval_claim_boundary_fix_20260409"
RUN_SCRIPT="$WORK_ROOT/scripts/run_tracewm_stage2_external_eval_claim_boundary_fix_20260409.sh"
