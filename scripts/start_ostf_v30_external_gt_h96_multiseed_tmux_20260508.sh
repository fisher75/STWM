...
LOG="$ROOT/logs/stwm_ostf_v30_extgt_h96_multiseed_20260508.log"
RUN="$ROOT/scripts/run_ostf_v30_external_gt_h96_multiseed_20260508.sh"
...
cat > "$ROOT/reports/stwm_ostf_v30_external_gt_h96_multiseed_launch_manifest_20260508.json" <<JSON
{
  "session": "$SESSION",
  "log": "${LOG#$ROOT/}",
