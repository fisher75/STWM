...
LOG="$ROOT/logs/stwm_ostf_v30_extgt_density_m512_pilot_20260508.log"
RUN="$ROOT/scripts/run_ostf_v30_external_gt_density_m512_pilot_20260508.sh"
...
cat > "$ROOT/reports/stwm_ostf_v30_density_m512_pilot_launch_manifest_20260508.json" <<JSON
{
  "session": "$SESSION",
  "log": "${LOG#$ROOT/}",
