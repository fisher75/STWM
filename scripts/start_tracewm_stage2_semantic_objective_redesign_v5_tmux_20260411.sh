...
MAIN_WINDOW="semobjv5_main"
QUAL_WINDOW="qual_pack"
LOG_PATH="${STWM_ROOT}/logs/tracewm_stage2_semantic_objective_redesign_v5_20260411.log"
RUN_SCRIPT="${STWM_ROOT}/scripts/run_tracewm_stage2_semantic_objective_redesign_v5_20260411.sh"
QUAL_SCRIPT="${STWM_ROOT}/scripts/run_tracewm_stage1_stage2_qualitative_pack_20260411.sh"
