...
LOG_PATH="${STWM_ROOT}/logs/stage1_stage2_qualitative_pack_20260411.log"
mkdir -p "${STWM_ROOT}/logs" "${STWM_ROOT}/tmp"

exec "${PYTHON_BIN}" "${STWM_ROOT}/code/stwm/tools/run_tracewm_stage1_stage2_qualitative_pack_20260411.py" "$@" 2>&1 | tee -a "${LOG_PATH}"
