...
LOG_PATH="/home/chen034/workspace/stwm/logs/stage2_tusb_v3p2_ceiling_lift_20260419.log"
...
EXTRA_ARGS=("$@")
CMD="cd '$ROOT' && bash scripts/run_stage2_tusb_v3p2_ceiling_lift_20260419.sh --mode run"
