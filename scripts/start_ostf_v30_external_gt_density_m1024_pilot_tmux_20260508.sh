...
LOG="$ROOT/logs/stwm_ostf_v30_extgt_density_m1024_pilot_20260508.log"
RUN="$ROOT/scripts/run_ostf_v30_external_gt_density_m1024_pilot_20260508.sh"
...
cat > "$ROOT/reports/stwm_ostf_v30_density_m1024_pilot_launch_manifest_20260508.json" <<JSON
{"session":"$SESSION","log":"${LOG#$ROOT/}","command":"bash ${RUN#$ROOT/}","launched_at_local":"$(date -Iseconds)","horizons":[32,64,96],"m_points":1024,"seeds":[42,123]}
JSON
